# Generated by Django 2.0.9 on 2021-03-06 18:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=17, validators=[django.core.validators.RegexValidator(message=' Phone number must be entered in the format: +9999999999. \n                    Up to 15 digits allowed.', regex='\\+?1?\\d{9,15}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reputation', models.FloatField(default=0.0, help_text="User's reputation based on the rides taken and ofered.")),
