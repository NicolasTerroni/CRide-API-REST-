...
class Circle(CRideModel):
    ...
    by its members. To join a cicrle you have to recieve a unique invitation
    of a member who's already in it.
    """
    ...
    members_limit = models.PositiveIntegerField(
        default=0,
        help_text='If a circle is limted this will be the limit on the number of members.'
    )
